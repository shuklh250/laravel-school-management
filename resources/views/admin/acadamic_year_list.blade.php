          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Acadamic Year List</li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="card-header">
                  <h3 class="card-title">Acadamic Year List </h3>
                </div>
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      @foreach($acadamic_year as $item )
                    <tr>
                            <td>{{$item->id}}</td>
                            <td>{{$item->name}}</td>
                            <td><a href="{{route('acadamic-year.edit',$item->id)}}  " class="btn btn-primary">Edit</a></td>
                            <td><a href="{{route('acadamic-year.delete',$item->id)}}" onclick="return confirm('Are you sure want to delete?');  " class="btn btn-danger">Delete</a></td>
