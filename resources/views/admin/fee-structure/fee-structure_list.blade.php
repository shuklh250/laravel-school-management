      ...
      <section class="content">
        ...
        @endif
            ...
            @enderror
                      ...
                      <div class="form-group col-md-2">
                        ...
                        <select name="acadamic_year_id" class="form-control">
                          ...
                          @foreach($acadamic_years as $acadamic)
                <option value="{{$acadamic->id}}" {{$acadamic->id==request('acadamic_year_id') ? 'selected':'' }}>{{$acadamic->name}}</option>
              @endforeach
                        </select>
                        @error('acadamic_year_id')
              <p class="text-danger">{{$message}}</p>
            @enderror
                      ...
                      <!-- Button aligned next to the selects -->
